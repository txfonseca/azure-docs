...
| Length constraints |<ul> <li>The total length must not exceed 113 characters</li><li>There can be up to 64 characters before the "\@\" symbol</li><li>There can be up to 48 characters after the "\@\" symbol</li><li>The "\#EXT#\" value in a guest user's UPN is included in the sum for 64 characters before the "\@\" symbol</li></ul> | 
